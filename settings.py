# Django settings for dns_mdb project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Tor Martin Slaaen', 'tormsl@sygard.no'),
)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'sql-server',                      # Set to empty string for localhost. Not used with sqlite3.
