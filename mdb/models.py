...
class Ip4Subnet(models.Model):
    ...
    dhcp_config = models.ForeignKey(DhcpConfig, on_delete=models.CASCADE)
...
class DhcpOption(models.Model):
    ...
    ip4subnet = models.ForeignKey(Ip4Subnet, on_delete=models.CASCADE)
...
class Ip4Address(models.Model):
    subnet = models.ForeignKey(Ip4Subnet, on_delete=models.CASCADE)
...
class Ip6Address(models.Model):
    subnet = models.ForeignKey(Ip6Subnet, on_delete=models.CASCADE)
